...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Chapters/05-results/sub-chapters/figures/05-results-coverage-single-machine.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Chapters/05-results/sub-chapters/figures/05-results-coverage-distributed.pdf}
...
\begin{figure}[H]
    ...
    \subfloat[Per-iteration elapsed-time distribution.\label{fig:results-warmup-distribution}]{%
        \includegraphics[valign=t, width=0.45\textwidth]{Chapters/05-results/sub-chapters/figures/05-results-warmup-distribution.pdf}}%
    \hfill
    \subfloat[Warmup-to-steady-state decay.\label{fig:results-warmup-decay}]{%
        \includegraphics[valign=t, width=0.45\textwidth]{Chapters/05-results/sub-chapters/figures/05-results-warmup-decay.pdf}}%
