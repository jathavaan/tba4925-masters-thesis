...
\input{Chapters/00-preliminary/sub-chapters/abstract} %insert the chapter text from the files

\chapter*{Preface}
\addcontentsline{toc}{chapter}{\protect\numberline{}Preface} 
\input{Chapters/00-preliminary/sub-chapters/preface}


\chapter*{Contents}
\addcontentsline{toc}{chapter}{\protect\numberline{}Contents} 
\input{Chapters/00-preliminary/sub-chapters/contents}
\cleardoublepage
