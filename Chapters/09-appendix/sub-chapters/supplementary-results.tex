...
\begin{figure}[H]
    ...
    \scaffoldbox{0.7}{Per-iteration distribution for one representative query, minimum and mean marked}
...
\begin{figure}[H]
    ...
    \scaffoldbox{0.75}{Coefficient of variation of per-iteration time per configuration (faceted by workload/tier)}
...
\begin{figure}[H]
    ...
    \scaffoldbox{0.75}{Stacked CPU time: user vs.\ system seconds per configuration}
...
\begin{figure}[H]
    ...
    \scaffoldbox{0.95}{Auto-generated per-cell grid: median bars, violin, network I/O, cost per workload $\times$ tier}
...
\begin{figure}[H]
    ...
    \scaffoldbox{0.9}{Raw Spark-internal metric distributions: executorRunTime, bytesRead, shuffle read/write, stage durations}
