...
\begin{table}[H]
    ...
    \begin{tabular}{@{}l l p{6.5cm} l@{}}
        ...
        Workload      & Varied      & See Section~\ref{sec:methodology:workloads} & \acrshort{rq}1, \acrshort{rq}2 \\
        \midrule
...
\label{sec:methodology:overview:replication}
